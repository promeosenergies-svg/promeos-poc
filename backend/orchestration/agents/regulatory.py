...
SCOPE_PROMPTS: dict[str, str] = {
    ...
    "audit-cesures": (
        ...
        "Phase L35.2 doctrine SoT alignment : la césure TURPE 6→7 est au 1/02/2025 "
        "(mouvement EXCEPTIONNEL CRE délibération 2025-78, PAS le calendrier annuel "
        "1/08 habituel). Les césures TVA réduite + accise gaz/élec restent au 1/08/2025 "
        "(LFI 2025).\n"
        "Pour chacune des dates suivantes, appelle `find_active_at_date` et confirme "
        "que les sections attendues sont bien actives :\n"
        "- 2025-01-31 : TURPE 6 doit être actif (dernière journée avant césure TURPE)\n"
        "- 2025-02-01 : TURPE 7 actif (mouvement exceptionnel CRE 2025-78). TVA réduite "
        "5,5% encore en vigueur, accise gaz 16.37 (TICGN_2024 reconduit).\n"
        "- 2025-07-31 : TURPE 7 actif (depuis fév), TVA réduite 5,5% dernier jour, "
        "accise gaz 16.37 dernier jour.\n"
        "- 2025-08-01 : TVA 20% uniforme (réduite supprimée LFI 2025) + accise gaz "
        "10.54 + accise élec T1 29.98 / T2 25.79 (césure double LFI 2025). TURPE 7 "
        "inchangé (déjà actif depuis 1/02/2025).\n"
        "- 2026-01-31 : grilles 2025 doivent encore être actives.\n"
        "- 2026-02-01 : CTA fév 2026 (15% élec / 20.80% gaz) + accise élec T1 30.85 / "
        "T2 26.58 + accise gaz 10.73.\n"
