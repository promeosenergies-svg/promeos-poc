...
_WOW_SITES = [
    ...
    {
        "nom": "Copropriete Toulouse",
        "type": TypeSite.COPROPRIETE,
        "ville": "Toulouse",
        "cp": "31000",
        "surface": 5000,
        "volume": 700_000,
    ...
    {
        "nom": "Logement Social Lille",
        "type": TypeSite.LOGEMENT_SOCIAL,
        "ville": "Lille",
        "cp": "59000",
        "surface": 4000,
        "volume": 550_000,
...
def seed_wow_happy(db: Session) -> dict:
    ...
    for site, spec in site_specs:
        ...
        contract = EnergyContract(
            site_id=site.id,
            energy_type=BillingEnergyType.ELEC,
            supplier_name=["EDF Entreprises", "Engie Elec", "TotalEnergies", "Vattenfall", "Alpiq"][
                assumptions_created % 5
            ],
