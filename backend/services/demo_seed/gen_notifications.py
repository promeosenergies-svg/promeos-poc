...
_TEMPLATES = [
    # --- BILLING (5) ---
    {
        ...
        "severity_key": "critical", "status_key": "new",
        ...
        "deeplink": "/bill-intel", "site_idx": 0, "due_days": 30, "impact_eur": 1240.0, "age_days": 2,
    },
    {
        "source_type_key": "billing",
        "source_key": "billing:invoice_missing:site_1",
        "severity_key": "warn", "status_key": "read",
        ...
        "deeplink": "/bill-intel", "site_idx": 1, "due_days": 15, "impact_eur": None, "age_days": 8,
    },
    {
        "source_type_key": "billing",
        ...
        "deeplink": "/billing/contracts", "site_idx": 1, "due_days": 45, "impact_eur": 5200.0, "age_days": 5,
    },
    {
        "source_type_key": "billing",
        "source_key": "billing:contract_expiry:site_2",
        "severity_key": "warn", "status_key": "new",
        ...
        "deeplink": "/billing/contracts", "site_idx": 2, "due_days": 90, "impact_eur": 3800.0, "age_days": 12,
    },
    {
        "source_type_key": "billing",
        ...
        "deeplink": "/billing/market", "site_idx": 3, "due_days": None, "impact_eur": 2100.0, "age_days": 3,
    },
    # --- CONSUMPTION (6) ---
    {
        ...
        "deeplink": "/usages-horaires", "site_idx": 0, "due_days": None, "impact_eur": 1550.0, "age_days": 6,
    },
    {
        "source_type_key": "consumption",
        "source_key": "consumption:base_load:site_0",
        "severity_key": "info", "status_key": "new",
        ...
        "deeplink": "/usages-horaires", "site_idx": 0, "due_days": None, "impact_eur": 680.0, "age_days": 15,
    },
    {
        "source_type_key": "consumption",
        ...
        "deeplink": "/usages-horaires", "site_idx": 2, "due_days": None, "impact_eur": 4200.0, "age_days": 10,
    },
    {
        "source_type_key": "consumption",
        ...
        "deeplink": "/monitoring", "site_idx": 3, "due_days": 14, "impact_eur": 3500.0, "age_days": 1,
    },
    {
        "source_type_key": "consumption",
        ...
        "deeplink": "/monitoring", "site_idx": 0, "due_days": None, "impact_eur": 1200.0, "age_days": 20,
    },
    {
        "source_type_key": "consumption",
        ...
        "deeplink": "/monitoring", "site_idx": 4, "due_days": None, "impact_eur": None, "age_days": 25,
    },
    # --- COMPLIANCE (5) ---
    {
        ...
        "deeplink": "/conformite", "site_idx": 3, "due_days": 45, "impact_eur": 1500.0, "age_days": 7,
    },
    {
        "source_type_key": "compliance",
        ...
        "deeplink": "/conformite/tertiaire", "site_idx": 1, "due_days": 60, "impact_eur": None, "age_days": 14,
    },
    {
        "source_type_key": "compliance",
        ...
        "deeplink": "/conformite/tertiaire", "site_idx": 0, "due_days": None, "impact_eur": 7500.0, "age_days": 30,
    },
    {
        "source_type_key": "compliance",
        "source_key": "compliance:aper:ombriere:site_2",
        "severity_key": "info", "status_key": "read",
        ...
        "deeplink": "/conformite", "site_idx": 2, "due_days": 120, "impact_eur": None, "age_days": 40,
    },
    {
        "source_type_key": "compliance",
        ...
        "deeplink": "/conformite", "site_idx": 4, "due_days": 30, "impact_eur": 1500.0, "age_days": 18,
    },
    # --- ACTION HUB (4) ---
    {
        ...
        "deeplink": "/actions", "site_idx": 3, "due_days": -12, "impact_eur": 8200.0, "age_days": 12,
    },
    {
        "source_type_key": "action_hub",
        ...
        "deeplink": "/actions", "site_idx": 2, "due_days": 30, "impact_eur": None, "age_days": 22,
    },
    {
        "source_type_key": "action_hub",
        "source_key": "action:completed:psub:site_0",
        "severity_key": "info", "status_key": "dismissed",
        ...
        "deeplink": "/actions", "site_idx": 0, "due_days": None, "impact_eur": 1800.0, "age_days": 45,
    },
    {
        "source_type_key": "action_hub",
        ...
        "deeplink": "/actions", "site_idx": 4, "due_days": 60, "impact_eur": 2400.0, "age_days": 4,
    },
]
