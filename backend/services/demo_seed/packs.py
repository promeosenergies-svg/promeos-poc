...
PACKS = {
    ...
    # 1 entite, 3 sites (bureaux + entrepot), isolation org complete
    # ══════════════════════════════════════════════════════════════════════════
    "meridian": {
        "visible": True,
        "label": "MERIDIAN SAS — Tertiaire compact",
        "description": "1 entite, 3 sites. Bureaux Levallois & Bordeaux, entrepot Gennevilliers.",
        "org": {"nom": "MERIDIAN SAS", "type_client": "tertiaire", "siren": "987654321"},
        "entites": [
            {
                "nom": "MERIDIAN SAS",
                "siren": "987654321",
        ...
        "portefeuilles": [
            {"nom": "Bureaux MERIDIAN", "description": "Bureaux tertiaires", "entite_idx": 0},
        ],
        "sizes": {"S": {}},
        "sites_explicit": [
            {
                "nom": "MERIDIAN Levallois",
                "portefeuille_idx": 0,
            ...
            },
            {
                ...
                "operat_status": "IN_PROGRESS",
                "buildings": [
                    {"nom": "Bureau Bordeaux", "surface_m2": 800, "annee": 2015, "cvc_kw": 40},
                ],
                "gas": False,
            },
            {
