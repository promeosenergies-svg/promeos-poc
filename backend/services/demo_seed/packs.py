...
PACKS = {
    ...
    "helios": {
        ...
        "entites": [
            {"nom": "HELIOS Immobilier SAS", "siren": "123456789",
             "siret": "12345678900014", "naf_code": "6820B", "region_code": "IDF"},
            {"nom": "HELIOS Industrie SARL", "siren": "234567890",
             "siret": "23456789000028", "naf_code": "2511Z", "region_code": "ARA"},
            {"nom": "HELIOS Services SCI", "siren": "345678901",
             "siret": "34567890100015", "naf_code": "6820A", "region_code": "PACA"},
        ],
        "portefeuilles": [
            {"nom": "Siege & Bureaux", "description": "Siege social et bureaux regionaux",
             "entite_idx": 0},
            {"nom": "Sites Industriels", "description": "Usines et entrepots",
             "entite_idx": 1},
            {"nom": "Patrimoine Tertiaire", "description": "Hotels, ecoles",
             "entite_idx": 2},
        ],
        "sizes": {"S": {}},
        "sites_explicit": [
            {
                "nom": "Siege HELIOS Paris", "portefeuille_idx": 0,
                "ville": "Paris", "cp": "75008", "region": "IDF",
                "lat": 48.8738, "lon": 2.2950,
                "type_site": "bureau", "profile": "office", "naf": "6820B",
                "surface_m2": 3500, "tertiaire_area_m2": 3500,
                "employees": 120, "psub_kva": 200, "annual_kwh": 800000,
                "cvc_kw": 300, "parking_m2": 1200, "roof_m2": 800,
                "parking_type": "underground",
                "operat_status": "SUBMITTED",
                "buildings": [
                    {"nom": "Batiment A — Siege", "surface_m2": 2000,
                     "annee": 1995, "cvc_kw": 200},
                    {"nom": "Batiment B — Annexe", "surface_m2": 1500,
                     "annee": 2010, "cvc_kw": 100},
                ],
                "gas": True,
            },
            {
                "nom": "Bureau Regional Lyon", "portefeuille_idx": 0,
                "ville": "Lyon", "cp": "69002", "region": "ARA",
                "lat": 45.7580, "lon": 4.8320,
                "type_site": "bureau", "profile": "office", "naf": "6820B",
                "surface_m2": 1200, "tertiaire_area_m2": 1200,
                "employees": 35, "psub_kva": 80, "annual_kwh": 350000,
                "cvc_kw": 50, "parking_m2": 400, "roof_m2": 300,
                "parking_type": "outdoor",
                "operat_status": "IN_PROGRESS",
                "buildings": [
                    {"nom": "Batiment principal", "surface_m2": 1200,
                     "annee": 2005, "cvc_kw": 50},
                ],
                "gas": False,
            },
            {
                "nom": "Usine HELIOS Toulouse", "portefeuille_idx": 1,
                "ville": "Toulouse", "cp": "31100", "region": "OCC",
                "lat": 43.5780, "lon": 1.4020,
                "type_site": "entrepot", "profile": "warehouse", "naf": "2511Z",
                "surface_m2": 6000, "tertiaire_area_m2": None,
                "employees": 85, "psub_kva": 400, "annual_kwh": 2500000,
                "cvc_kw": 150, "parking_m2": 2000, "roof_m2": 3000,
                "parking_type": "outdoor",
                "operat_status": None,
                "buildings": [
                    {"nom": "Batiment industriel", "surface_m2": 6000,
                     "annee": 1988, "cvc_kw": 150},
                ],
                "gas": True,
            },
            {
                "nom": "Hotel Helios Nice", "portefeuille_idx": 2,
                "ville": "Nice", "cp": "06000", "region": "PACA",
                "lat": 43.7050, "lon": 7.2650,
                "type_site": "hotel", "profile": "hotel", "naf": "5510Z",
                "surface_m2": 4000, "tertiaire_area_m2": 4000,
                "employees": 60, "psub_kva": 250, "annual_kwh": 1200000,
                "cvc_kw": 280, "parking_m2": 800, "roof_m2": 600,
                "parking_type": "underground",
                "operat_status": "NOT_STARTED",
                "buildings": [
                    {"nom": "Batiment hotel", "surface_m2": 4000,
                     "annee": 2000, "cvc_kw": 280},
                ],
                "gas": True,
            },
            {
                "nom": "Ecole Jules Ferry Marseille", "portefeuille_idx": 2,
                "ville": "Marseille", "cp": "13005", "region": "PACA",
                "lat": 43.2950, "lon": 5.3950,
                "type_site": "enseignement", "profile": "school", "naf": "8520Z",
                "surface_m2": 2800, "tertiaire_area_m2": 2800,
                "employees": 45, "psub_kva": 150, "annual_kwh": 600000,
                "cvc_kw": 120, "parking_m2": 600, "roof_m2": 1200,
                "parking_type": "outdoor",
                "operat_status": "IN_PROGRESS",
                "buildings": [
                    {"nom": "Batiment principal — Ecole", "surface_m2": 2000,
                     "annee": 1975, "cvc_kw": 80},
                    {"nom": "Gymnase", "surface_m2": 800,
                     "annee": 2015, "cvc_kw": 40},
                ],
                "gas": False,
            },
        ],
