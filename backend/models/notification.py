...
class NotificationEvent(Base, TimestampMixin):
    ...
    source_type = Column(
        SAEnum(NotificationSourceType), nullable=False, index=True,
    ...
    severity = Column(
        SAEnum(NotificationSeverity), nullable=False, index=True,
    ...
    status = Column(
        SAEnum(NotificationStatus), default=NotificationStatus.NEW, nullable=False,
        index=True, comment="Statut: new, read, dismissed",
    )
    inputs_hash = Column(
