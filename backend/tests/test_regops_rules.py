...
from models import (
    Site, Batiment, Evidence, TypeSite, ParkingType, OperatStatus,
...
def test_aper_non_outdoor_parking(configs):
    ...
    parking_findings = [f for f in findings if 'parking' in f.explanation.lower() or 'stationnement' in f.explanation.lower()]
    if parking_findings:
