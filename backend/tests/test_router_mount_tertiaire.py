...
class TestImportChain:
    ...
    def test_router_has_routes(self):
        ...
        assert len(tertiaire_router.routes) >= 10, f"Expected >= 10 routes, got {len(tertiaire_router.routes)}"
...
class TestAppMountTertiaire:
    ...
    def test_get_efa_list_returns_200(self):
        ...
        assert resp.status_code == 200, (
            f"GET /api/tertiaire/efa returned {resp.status_code}, expected 200. Router not mounted?"
        )
    ...
    def test_post_efa_returns_201(self):
        ...
        assert resp.status_code == 201, f"POST /api/tertiaire/efa returned {resp.status_code}, expected 201"
...
class TestSwaggerExposure:
    ...
    def test_openapi_contains_tertiaire_efa(self):
        ...
        assert "/api/tertiaire/efa" in paths, (
            "'/api/tertiaire/efa' missing from OpenAPI schema — Swagger /docs will not show tertiaire routes"
        )
    ...
    def test_openapi_tertiaire_count(self):
        ...
        assert len(tertiaire) >= 10, f"Expected >= 10 tertiaire paths in OpenAPI, got {len(tertiaire)}"
    ...
    def test_tertiaire_tag_exists(self):
        ...
        assert "Tertiaire / OPERAT" in tags, f"Expected tag 'Tertiaire / OPERAT', got {tags}"
