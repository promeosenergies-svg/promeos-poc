/**
 * PROMEOS - Base de Connaissances (/kb)
 * FTS5 search + browse KB items (validated + drafts)
 */
          ...
          <div className="mt-3 pt-3 border-t border-gray-100 space-y-3">
            ...
            {item.logic && (
              <div className="bg-blue-50 rounded-lg p-3">
                <p className="text-xs font-semibold text-blue-700 mb-1">Logique d'evaluation</p>
            ...
            <div className="flex items-center gap-4 text-xs text-gray-400">
              ...
              {item.priority && <span>Priorite: {item.priority}</span>}
            </div>
          </div>
        )}
      </CardBody>
