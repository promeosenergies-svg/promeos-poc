        ...
        <>
            ...
            <div className="grid grid-cols-3 gap-3 mb-4" data-testid="donnees-kpis">
              ...
              <Card>
                <CardBody className="py-3">
                  ...
                  <p className="text-lg font-bold text-gray-900 mb-1">
                    {Math.round(donneesMetrics.completude_pct)}%
                  </p>
                  <Progress
                    value={donneesMetrics.completude_pct}
                    size="sm"
                    color={
                      donneesMetrics.completude_pct >= 80
                        ? 'green'
                        : donneesMetrics.completude_pct >= 50
                          ? 'amber'
                          : 'red'
                    }
                  />
                ...
                <CardBody className="py-3">
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-lg font-bold text-gray-900">
                      {donneesMetrics.confiance_label}
                    </p>
                    <Badge
                      status={
                        donneesMetrics.confiance_level === 'high'
                          ? 'ok'
                          : donneesMetrics.confiance_level === 'medium'
                            ? 'warn'
                            : 'crit'
                      }
                    >
              ...
              <Card>
                <CardBody className="py-3">
                  ...
                  <p className="text-lg font-bold text-gray-900 mb-1">
                    {donneesMetrics.couverture_factures_mois}
                    <span className="text-xs font-normal text-gray-400">
                      /{donneesMetrics.couverture_factures_cible} mois
                    </span>
                  </p>
                  <Progress
                    value={
                      (donneesMetrics.couverture_factures_mois /
                        donneesMetrics.couverture_factures_cible) *
                      100
                    }
                    size="sm"
                    color={
                  ...
                  {donneesMetrics.gaps.map((gap) => (
                    ...
                    >
                      ...
                      <Button
                        ...
                        variant="secondary"
                        onClick={() => {
                          navigate(gap.ctaPath);
                          track('donnees_gap_cta', { gap: gap.id });
                        }}
                      >
                        {gap.ctaLabel}
                      </Button>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-sm font-semibold text-gray-700">
              Qualité des données par site ({scopedSites.length})
            </h3>
          </div>
            ...
            <Card>
              <CardBody>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-semibold text-gray-700">
                    Questions en attente ({intakeQuestions.length})
                  </h3>
                </div>
                <div className="space-y-2">
