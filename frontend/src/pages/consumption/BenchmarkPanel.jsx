...
export default function BenchmarkPanel({ siteId, days, startDate, endDate, toast }) {
  ...
  const load = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const data = await getEmsReferenceProfile(
        siteId,
        dateFrom,
        dateTo,
        famille,
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <Card>
                <CardBody className="py-3 px-4 text-center">
                  ...
                  <p
                    ...
                    title="Estime a partir des releves compteur"
                  >
                    Source : releves
                  </p>
                </CardBody>
              ...
              <Card>
                <CardBody className="py-3 px-4 text-center">
                  ...
                  <p
                    className="text-[10px] text-gray-400"
                    title="Pourcentage de points de mesure disponibles vs attendus"
                  >
                    Points mesures / attendus
                  </p>
                </CardBody>
              </Card>
            </div>
            ...
            <Card>
              <CardBody>
                ...
                <p className="text-[10px] text-gray-400 mt-1 text-center">
                  Profil : {FAMILLE_OPTIONS.find((o) => o.value === famille)?.label} ·{' '}
                  {PUISSANCE_OPTIONS.find((o) => o.value === puissance)?.label}
                </p>
              </CardBody>
            </Card>
          )}
