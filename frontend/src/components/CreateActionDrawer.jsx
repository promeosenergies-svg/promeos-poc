...
import { Paperclip, Lock, Info } from 'lucide-react';
...
export default function CreateActionDrawer({
  ...
  const showEvidenceToggle = evidenceReq.required || form.priorite === 'critical' || form.priorite === 'high';
          ...
          <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <p className="text-sm text-slate-700 font-medium">
              {sourceType === 'compliance' ? 'Conformité' :
               ...
               sourceType === 'insight' ? 'Diagnostic' : sourceType}
