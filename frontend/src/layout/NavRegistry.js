    ...
    items: [
      {
        ...
        desc: 'Score conformité, obligations par site',
      ...
      },
      {
        ...
        desc: 'Trajectoire -40% sur le parc tertiaire',
      ...
      },
      {
        ...
        desc: 'GTB/GTC obligatoire > 290 kW',
      ...
      },
      {
        ...
        icon: SearchCheck,
        label: 'Audit SMÉ',
        desc: 'Audit énergétique obligatoire > 250 salariés',
        expertOnly: true,
  ...
  // === ACHAT (violet) — visible en normal ===
  {
    ...
    items: [
      ...
      },
      {
        ...
        desc: 'Comparer offres, simuler arbitrages',
      ...
      },
      {
        ...
        desc: 'Wizard 8 étapes : profil → offres → scoring',
        expertOnly: true,
