...
export const CONFIDENCE_CFG = {
  high:   { label: 'Haute',   dot: 'bg-emerald-500', bg: 'bg-emerald-50', text: 'text-emerald-700', border: 'border-emerald-200' },
  medium: { label: 'Moyenne', dot: 'bg-amber-400',   bg: 'bg-amber-50',   text: 'text-amber-700',   border: 'border-amber-200' },
  low:    { label: 'Basse',   dot: 'bg-red-400',     bg: 'bg-red-50',     text: 'text-red-700',     border: 'border-red-200' },
};
 ...
 */
export function buildEvidence({ id, title, valueLabel, scopeLabel, periodLabel, sources, method, assumptions, owner = 'PROMEOS Engine' }) {
  return {
    id,
    title,
