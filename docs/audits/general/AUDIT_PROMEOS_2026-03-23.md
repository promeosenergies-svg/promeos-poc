...
| --- | --- | --- |
| 0 — Cadrage | `docs/audits/program/AUDIT_PROMEOS_ETAPE_00_CADRAGE_2026-03-23.md` | Baseline, périmètre, cartographie, conventions |
| 1 — Fil conducteur | `docs/audits/program/AUDIT_PROMEOS_ETAPE_01_FIL_CONDUCTEUR_2026-03-23.md` | Trace code-path complète patrimoine→actions |
| 2 — Règles métier | `docs/audits/program/AUDIT_PROMEOS_ETAPE_02_REGLES_METIER_CONFORMITE_2026-03-23.md` | Formules, seuils, deadlines, scoring, preuves |
