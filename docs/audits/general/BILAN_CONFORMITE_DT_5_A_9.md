...
- Livrable : `docs/audits/general/DT_AUDIT_PHASE1.md`
...
- Livrable : `docs/audits/general/DT_AUDIT_PHASE2_RESULTS.md`
...
- Livrable : `docs/audits/general/DT_AUDIT_PHASE3_RESULTS.md`
...
- Livrable : `docs/audits/general/DT_AUDIT_PHASE4_FINAL.md`
...
- Livrable : `docs/audits/general/DT_AUDIT_PHASE5_FINAL.md`
...
- Livrable : `docs/audits/general/DT_AUDIT_PHASE6_FINAL.md`
...
| `docs/audits/general/DT_AUDIT_PHASE1.md` | ~365 | Rapport audit initial |
| `docs/audits/general/DT_AUDIT_PHASE2_RESULTS.md` | ~190 | Rapport fondations |
| `docs/audits/general/DT_AUDIT_PHASE3_RESULTS.md` | ~205 | Rapport differenciateurs |
| `docs/audits/general/DT_AUDIT_PHASE4_FINAL.md` | ~148 | Rapport polish |
