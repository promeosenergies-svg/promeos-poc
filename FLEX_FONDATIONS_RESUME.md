...
| Fichier | Contenu |
|---------|---------|
| [docs/audit/flex-current-vision-audit.md](docs/audit/flex-current-vision-audit.md) | Audit complet technique + réglementaire |
| [docs/backlog/flex-sprint-21-spec.md](docs/backlog/flex-sprint-21-spec.md) | Spec exécutable Sprint 21 |
| [docs/adr/ADR-flex-foundation-v2.md](docs/adr/ADR-flex-foundation-v2.md) | Décisions architecture |
