/**
 * Playwright UI Rescue Sprint — BEFORE screenshots
 * Captures: Patrimoine, Site detail, Consommation KPIs, Performance, Anomalies
 * At multiple widths: 1440, 1280, 1024
 */
import { chromium } from 'playwright';
import { mkdirSync } from 'fs';

const DIR = 'playwright-screenshots/rescue-before';
...
(async () => {
  ...
  await browser.close();
  console.log(`\n✅ BEFORE screenshots saved to ${DIR}/`);
})();
